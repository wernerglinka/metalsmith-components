...
sections:
  ...
  - sectionType: text-only
    ...
    text:
      ...
      subTitle: ''
      prose: |-
        ## Metalsmith Plugin Setup

        The search component requires the `metalsmith-search` plugin to be properly configured in your `metalsmith.js` build file.
  ...
  - sectionType: text-only
    ...
    text:
      ...
      subTitle: ''
      prose: |-
        ## Critical Field Synchronization

        The search component's client-side Fuse.js configuration must exactly match the fields generated by the metalsmith-search plugin.
  ...
  - sectionType: text-only
    ...
    text:
      ...
      prose: |-
        ...
        Enable comprehensive debug output to troubleshoot plugin behavior:
        ...
        **For Large Sites:**
        ...
        .use(search({
          ...
          chunkSize: 1000,
          stripHtml: true,                // Reduce index size
